...
$img = $pdo->prepare('INSERT INTO pratos (caminho, nome, descricao, valor, calorias, carboidratos, proteinas, gordura, sodio) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)');
    ...
    echo "<script>
        ...
        window.location.href='../view/telaFuncionario.php'
        </script>";
?>
