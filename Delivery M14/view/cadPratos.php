...
<body>
    <div id="hotbar">
        ...
        <input class="barras lugar"  type="text" name="descricao" id="descricao" placeholder="descricao"><br>
        <input class="barras lugar"  type="text" name="valor" id="valor" placeholder="Valor"><br>
        <input class="barras lugar"  type="text" name="calorias" id="calorias" placeholder="calorias"><br>
        <input class="barras lugar"  type="text" name="carboidratos" id="carboidratos" placeholder="carboidratos"><br>
        <input class="barras lugar"  type="text" name="proteinas" id="proteinas" placeholder="proteinas"><br>
        <input class="barras lugar"  type="text" name="gordura" id="gordura" placeholder="gordura"><br>
        <input class="barras lugar"  type="text" name="sodio" id="sodio" placeholder="sodio"><br>
